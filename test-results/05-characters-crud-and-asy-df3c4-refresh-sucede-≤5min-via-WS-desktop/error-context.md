...
- Name: 05-characters-crud-and-async-refresh.spec.ts >> Characters CRUD + async refresh >> @paridade @critico async refresh sucede ≤5min via WS
- Location: parity\specs\05-characters-crud-and-async-refresh.spec.ts:29:7
