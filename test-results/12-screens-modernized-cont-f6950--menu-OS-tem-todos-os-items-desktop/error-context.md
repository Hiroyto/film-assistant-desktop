...
- Name: 12-screens-modernized-contract-parity.spec.ts >> @paridade-comportamental telas modernizadas (4) >> @paridade-comportamental @critico menu OS tem todos os items
- Location: parity\specs\12-screens-modernized-contract-parity.spec.ts:9:7
...
Expected: ArrayContaining ["New Story", "Save", "Settings…", "Quit"]
Received: undefined
```
