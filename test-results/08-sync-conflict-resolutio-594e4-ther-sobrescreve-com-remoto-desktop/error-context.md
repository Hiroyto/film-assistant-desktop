...
- Name: 08-sync-conflict-resolution.spec.ts >> Sync conflict resolution >> @paridade @critico @conflito Use other sobrescreve com remoto
- Location: parity\specs\08-sync-conflict-resolution.spec.ts:23:7
...
Call log:
  - waiting for getByRole('radio', { name: /other device/i })
