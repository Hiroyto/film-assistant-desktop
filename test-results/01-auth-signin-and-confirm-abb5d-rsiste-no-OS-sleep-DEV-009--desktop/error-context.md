...
- Name: 01-auth-signin-and-confirm.spec.ts >> Auth: sign-up + confirm + sign-in >> @paridade @critico @regressao-esperada resend cooldown persiste no OS sleep (DEV-009)
- Location: parity\specs\01-auth-signin-and-confirm.spec.ts:34:7
...
Call log:
  - waiting for getByRole('button', { name: /resend code/i })
    ...
    - generic [ref=e32]:
      - generic [ref=e33]:
        - generic [ref=e34]:
          ...
          - textbox "Let your creativity flow freely..." [ref=e38]: A chef inherits a restaurant with
          - generic [ref=e39]:
