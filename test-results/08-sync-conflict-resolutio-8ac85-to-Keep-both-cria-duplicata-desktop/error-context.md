...
- Name: 08-sync-conflict-resolution.spec.ts >> Sync conflict resolution >> @paridade @critico @conflito Keep both cria duplicata
- Location: parity\specs\08-sync-conflict-resolution.spec.ts:31:7
...
Call log:
  - waiting for getByRole('radio', { name: /keep both/i })
