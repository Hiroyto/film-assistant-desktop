...
- Name: 01-auth-signin-and-confirm.spec.ts >> Auth: sign-up + confirm + sign-in >> @paridade @critico resend respeita throttle 60s
- Location: parity\specs\01-auth-signin-and-confirm.spec.ts:25:7
