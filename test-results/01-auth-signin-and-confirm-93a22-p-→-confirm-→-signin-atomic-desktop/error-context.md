...
- Name: 01-auth-signin-and-confirm.spec.ts >> Auth: sign-up + confirm + sign-in >> @paridade @critico sign-up → confirm → signin atomic
- Location: parity\specs\01-auth-signin-and-confirm.spec.ts:6:7
