...
- Name: 07-offline-edit-and-reconnect-sync.spec.ts >> Offline edit + reconnect sync >> @paridade @critico @reconnect reconnect flush automático
- Location: parity\specs\07-offline-edit-and-reconnect-sync.spec.ts:24:7
...
Call log:
  ...
  - waiting for getByText(/syncing/i)
