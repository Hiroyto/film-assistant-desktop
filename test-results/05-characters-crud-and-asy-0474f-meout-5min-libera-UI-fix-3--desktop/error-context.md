...
- Name: 05-characters-crud-and-async-refresh.spec.ts >> Characters CRUD + async refresh >> @paridade @critico @regressao-esperada refresh timeout 5min libera UI (fix #3)
- Location: parity\specs\05-characters-crud-and-async-refresh.spec.ts:37:7
