...
- Name: 06-stripe-checkout-via-deep-link.spec.ts >> Stripe checkout (deep link + polling) >> @paridade deep link cancel não afeta subscription
- Location: parity\specs\06-stripe-checkout-via-deep-link.spec.ts:31:7
...
Call log:
  ...
  - waiting for getByText(/cancelled/i)
...
- textbox "Let your creativity flow freely..."
