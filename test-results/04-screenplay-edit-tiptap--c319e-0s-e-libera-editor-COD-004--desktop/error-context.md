...
- Name: 04-screenplay-edit-tiptap-and-sync.spec.ts >> Screenplay edit (TipTap) + sync >> @paridade @critico @regressao-esperada watchdog expira ~150s e libera editor (COD-004)
- Location: parity\specs\04-screenplay-edit-tiptap-and-sync.spec.ts:35:7
...
Call log:
  - waiting for getByRole('button', { name: /improve/i })
