...
- Name: 06-stripe-checkout-via-deep-link.spec.ts >> Stripe checkout (deep link + polling) >> @paridade @critico @plataforma Subscribe abre Stripe externo + inicia polling
- Location: parity\specs\06-stripe-checkout-via-deep-link.spec.ts:5:7
