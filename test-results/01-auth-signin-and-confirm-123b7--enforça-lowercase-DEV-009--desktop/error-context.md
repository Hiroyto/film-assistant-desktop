...
- Name: 01-auth-signin-and-confirm.spec.ts >> Auth: sign-up + confirm + sign-in >> @paridade @regressao-esperada password validator enforça lowercase (DEV-009)
- Location: parity\specs\01-auth-signin-and-confirm.spec.ts:47:7
