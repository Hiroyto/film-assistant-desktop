...
- Name: 06-stripe-checkout-via-deep-link.spec.ts >> Stripe checkout (deep link + polling) >> @paridade @critico @plataforma @regressao-esperada polling fallback pega webhook
- Location: parity\specs\06-stripe-checkout-via-deep-link.spec.ts:24:7
