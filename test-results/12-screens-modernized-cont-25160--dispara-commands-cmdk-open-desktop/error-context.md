...
- Name: 12-screens-modernized-contract-parity.spec.ts >> @paridade-comportamental telas modernizadas (4) >> @paridade-comportamental View>Command Palette dispara commands.cmdk.open
- Location: parity\specs\12-screens-modernized-contract-parity.spec.ts:24:7
...
Locator: getByRole('dialog', { name: /command/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: /command/i })
...
- textbox "Let your creativity flow freely...": A detective discovers their partner is the serial killer they've been hunting...
