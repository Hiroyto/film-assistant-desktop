...
- Name: 10-ai-three-handoff-pipeline.spec.ts >> AI three-handoff pipeline >> @paridade @critico pipeline completo com requires_third_handoff=true
- Location: parity\specs\10-ai-three-handoff-pipeline.spec.ts:5:7
