...
- Name: 03-story-create-edit-save-local-first.spec.ts >> Story create + edit + save (local-first) >> @paridade @critico editar foundation → debounce 10s + write local
- Location: parity\specs\03-story-create-edit-save-local-first.spec.ts:18:7
...
Call log:
  - waiting for getByLabel(/genre/i)
