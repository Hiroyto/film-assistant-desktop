...
- Name: 08-sync-conflict-resolution.spec.ts >> Sync conflict resolution >> @paridade @critico @conflito Keep mine preserva versão local + snapshot
- Location: parity\specs\08-sync-conflict-resolution.spec.ts:15:7
...
Call log:
  - waiting for getByRole('radio', { name: /keep my version/i })
