...
- Name: 12-screens-modernized-contract-parity.spec.ts >> @paridade-comportamental telas modernizadas (4) >> @paridade-comportamental @ipc todos os events shell→renderer chegam com schema válido
- Location: parity\specs\12-screens-modernized-contract-parity.spec.ts:99:7
