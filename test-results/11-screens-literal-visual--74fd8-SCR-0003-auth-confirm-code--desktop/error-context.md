...
- Name: 11-screens-literal-visual-parity.spec.ts >> @paridade-visual telas literal (26) >> @paridade-visual @critico SCR-0003 auth.confirm-code 
- Location: parity\specs\11-screens-literal-visual-parity.spec.ts:47:9

# Error details

```
Error: A snapshot doesn't exist at C:\Otavio\filmassistantai-electron\filmassistant-desktop\parity\specs\11-screens-literal-visual-parity.spec.ts-snapshots\auth-confirm-code-desktop-win32.png, writing actual.
```
    ...
    - generic [ref=e38]:
      - generic [ref=e39]:
        - generic [ref=e40]:
          ...
          - textbox "Let your creativity flow freely..." [ref=e44]: A detective discovers their partner is the serial killer they've been h
          - generic [ref=e45]:
