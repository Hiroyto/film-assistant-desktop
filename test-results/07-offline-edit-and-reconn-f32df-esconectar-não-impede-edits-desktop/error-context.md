...
- Name: 07-offline-edit-and-reconnect-sync.spec.ts >> Offline edit + reconnect sync >> @paridade @critico @offline desconectar não impede edits
- Location: parity\specs\07-offline-edit-and-reconnect-sync.spec.ts:7:7
