...
- Name: 07-offline-edit-and-reconnect-sync.spec.ts >> Offline edit + reconnect sync >> @paridade @offline edit offline + web simultânea → conflict
- Location: parity\specs\07-offline-edit-and-reconnect-sync.spec.ts:49:7
...
Call log:
  ...
  - waiting for getByText(/conflict/i)
