...
- Name: 12-screens-modernized-contract-parity.spec.ts >> @paridade-comportamental telas modernizadas (4) >> @paridade-comportamental Later grava timestamp e não re-prompt <24h
- Location: parity\specs\12-screens-modernized-contract-parity.spec.ts:66:7
