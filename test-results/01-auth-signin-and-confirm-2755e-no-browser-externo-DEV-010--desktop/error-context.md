...
- Name: 01-auth-signin-and-confirm.spec.ts >> Auth: sign-up + confirm + sign-in >> @paridade @critico @plataforma Terms abre no browser externo (DEV-010)
- Location: parity\specs\01-auth-signin-and-confirm.spec.ts:68:7
