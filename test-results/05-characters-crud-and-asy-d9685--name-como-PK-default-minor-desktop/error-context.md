...
- Name: 05-characters-crud-and-async-refresh.spec.ts >> Characters CRUD + async refresh >> @paridade @critico add usa name como PK + default minor
- Location: parity\specs\05-characters-crud-and-async-refresh.spec.ts:5:7
...
Call log:
  - waiting for getByRole('button', { name: /add character/i })
