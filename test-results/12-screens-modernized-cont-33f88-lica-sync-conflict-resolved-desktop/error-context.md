...
- Name: 12-screens-modernized-contract-parity.spec.ts >> @paridade-comportamental telas modernizadas (4) >> @paridade-comportamental @critico @conflito Apply publica sync.conflict.resolved
- Location: parity\specs\12-screens-modernized-contract-parity.spec.ts:83:7
...
Call log:
  ...
  - waiting for getByText(/applying/i)
...
- banner:
  ...
  - button:
    - img
- heading "Every Great Story Starts with a Single Spark" [level=1]
- paragraph: Turn a spark into your next project.
- textbox "Let your creativity flow freely...": In a world where m
- button "Build Your Story"
- text: or
- button "Blank Outline"
- button "View Your Stories":
  - text: View Your Stories
  - img
- heading "Continue Building 0 / 5" [level=2]:
...
- status "Sync detected conflicting versions. Click to review.":
  - img
  - text: Conflict — click to resolve
  - button "Resolve"
```
