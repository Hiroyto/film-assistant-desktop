...
- Name: 03-story-create-edit-save-local-first.spec.ts >> Story create + edit + save (local-first) >> @paridade @critico AI response força immediate save
- Location: parity\specs\03-story-create-edit-save-local-first.spec.ts:28:7
...
Call log:
  - waiting for getByRole('button', { name: /generate synopsis/i })
